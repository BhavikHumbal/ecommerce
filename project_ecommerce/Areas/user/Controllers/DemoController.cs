    ...
    public class DemoController : Controller
    {
        ...
        public void Demo(FormCollection form)
        {
            try
            {
                ...
                string furl = "/user/Default/Failed";  //Change the failure url here depending upon the port number of your local system.
                ...
                string key = "bBFTqB";
                //Add your SaltID;  
                string salt = "J7u7XXiDjCt4I1jGln5Q7vkjZVa9wKZB";
